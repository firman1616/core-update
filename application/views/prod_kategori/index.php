    ...
    <div class="page-inner">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="" id="bagianForm" name="bagianForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Marketing">
                            </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Table Produk Kategori</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="div-table-prod-kategori"></div>
                        </div>
                    </div>
                </div>
            </div>
