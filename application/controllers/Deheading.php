...
class Deheading extends CI_Controller
{
    ...
    {
        $data = [
            'title' => 'Data Deheading',
            'conten' => 'deheading/index',
            'footer_js' => array('assets/js/deheading.js')
        ];
    ...
    {
        $data = [
            'title' => 'Create Deheading Data',
            'conten' => 'deheading/tambah-data',
            'footer_js' => array('assets/js/deheading.js')
        ];
        $this->load->view('template/conten', $data);
    }
